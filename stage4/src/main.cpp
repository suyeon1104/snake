...
int main()
{
    ...
    {   
        ...
        if(snake.getGatepass() == true)
        {
            ...
            {
            aGate = snake.RandomGate(Map::mapDatas[0],bGate.x,bGate.y);
            snake.setGate1(aGate.x,aGate.y);
            bGate = snake.RandomGate(Map::mapDatas[0],aGate.x,aGate.y);
            snake.setGate2(bGate.x,bGate.y);
            Map::bgMap.setbgMapraw(Map::mapDatas[0]);
            // snake.setGate1(20,5);
            // snake.setGate2(3,0);
            Map::bgMap.setbgMapgate(Map::mapDatas[0],aGate.x,aGate.y,bGate.x,bGate.y);
